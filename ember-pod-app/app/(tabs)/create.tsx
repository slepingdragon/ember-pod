...
const PRODUCT_TYPES: ProductType[] = [
  { id: 'tee',     name: 'T-shirt',  emoji: '\uD83D\uDC55', basePrice: 18, blurb: 'Bella+Canvas 3001' },
  { id: 'hoodie',  name: 'Hoodie',   emoji: '\uD83E\uDDE5', basePrice: 38, blurb: 'Gildan 18500'      },
  { id: 'mug',     name: 'Mug',      emoji: '\u2615',       basePrice: 12, blurb: '11oz ceramic'      },
  { id: 'sticker', name: 'Sticker',  emoji: '\u2728',       basePrice: 3,  blurb: 'Die-cut vinyl'     },
];
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: 'transparent' }}>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 120 }} showsVerticalScrollIndicator={false}>
          ...
          <View style={{ flexDirection: 'row', gap: 12 }}>
            {PRODUCT_TYPES.slice(0, 2).map((p) => {
              ...
              return (
                ...
                >
                  <View style={{ padding: 18, minHeight: 160, justifyContent: 'space-between' }}>
        ...
        {/* COMING NEXT — placeholder canvas preview */}
        <View style={{ paddingHorizontal: 20, marginTop: 28 }}>
          ...
          <GlassCard strong>
            <View style={{ padding: 22, alignItems: 'center' }}>
              ...
              >
                <Text style={{ fontSize: 84, opacity: 0.85 }}>
                  {selected
                    ? PRODUCT_TYPES.find((p) => p.id === selected)?.emoji
                    : '\uD83D\uDC55'}
                </Text>
                <View
                  style={{
                ...
                >
                  <Text style={{ color: 'rgba(255,255,255,0.7)', fontSize: 10, fontWeight: '700', letterSpacing: 0.6 }}>
                    PREVIEW
                  </Text>
                </View>
              </View>
        ...
        <View style={{ paddingHorizontal: 20, marginTop: 22 }}>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ gap: 10 }}>
            {[0, 1, 2, 3, 4].map((i) => (
              ...
              >
                <Text style={{ color: 'rgba(255,255,255,0.25)', fontSize: 22 }}>+</Text>
              </View>
            ))}
          </ScrollView>
